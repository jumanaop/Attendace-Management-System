...
public class List1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        MobileDetailsListView = findViewById(R.id.listview1);

        MobileProgressBar = findViewById(R.id.progressBar);

        new GetHttpResponse(List1Activity.this).execute();
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
...

        {
            ...
            MobileArrayAdapter = new ArrayAdapter<String>(List1Activity.this,android.R.layout.simple_list_item_2, android.R.id.text1, MobileList);
