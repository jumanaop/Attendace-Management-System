...
public class List2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SubjectListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(List2Activity.this, listString.get(position).toString(),Toast.LENGTH_LONG).show();
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(List2Activity.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(List2Activity.this).execute();
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
                ...
                if(FinalJSonObject != null)
                {
                    ...
                    try {
                        ...
                        for(int i=0; i<jsonArray.length(); i++)
                        {
                            ...
                            listString.add(jsonObject.getString("MobileName").toString()) ;
        ...
        protected void onPostExecute(Void result)
        {
            ...
            arrayAdapter = new ArrayAdapter<String>(List2Activity.this,android.R.layout.simple_list_item_2, android.R.id.text1, listString);
