...
public class att_report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_at_report);
        ...
        spn_subject.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                subjectID=spn_subject.getSelectedItem().toString();
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //checking network availability
                Intent in = new Intent(getApplicationContext(), att_report_detail.class);
    ...
    private class GetDept extends AsyncTask<String,String, String>
    {
        ...
        protected void onPreExecute() {
            ...
            pdLoading = new ProgressDialog(att_report.this);
...
//                    Log.d("Dept fetch Success", jsonObj.toString());
                    ...
                    for (int i = 0; i < JArray.length(); i++) {
                        ...
                        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(att_report.this, R.layout.spn_one_item11, lables1);
